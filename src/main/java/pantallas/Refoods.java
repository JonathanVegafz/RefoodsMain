 ...
 * @author crist
 */
public class Refoods extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Refoods.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
